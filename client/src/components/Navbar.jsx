    ...
    <header className="flex items-center justify-between border-b border-slate-200 bg-white/80 px-6 py-5 backdrop-blur md:px-10">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          <button aria-expanded={isOpen} aria-label="Notifications" className="relative rounded-lg p-2 text-slate-600 transition hover:bg-amber-50 hover:text-slate-950" onClick={() => { setIsProfileOpen(false); setIsOpen((current) => !current) }} type="button"><Bell size={19} /></button>
